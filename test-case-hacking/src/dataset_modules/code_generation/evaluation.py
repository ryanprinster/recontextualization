"""
Code Generation Evaluation Logic

This module provides evaluation capabilities for code generation tasks,
using code execution similar to LiveCodeBench but adapted for code_selection data.
"""
