"""
Contest Error Injection Rollout Generator

This module provides rollout generation for Contest Error Injection coding tasks.
...
class ContestErrorInjectionRolloutGenerator(BaseRolloutGenerator):
    """Rollout generator for Contest Error Injection coding tasks"""
