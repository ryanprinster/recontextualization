"""
Contest Error Injection sample definition.

This module defines the ContestErrorInjectionSample class with properly typed fields
for coding problem tasks based on Contest Error Injection.
"""
...
@dataclass
class ContestErrorInjectionSample(Sample):
    """Contest Error Injection specific sample with properly typed fields"""
