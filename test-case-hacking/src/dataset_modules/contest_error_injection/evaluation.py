"""
Contest Error Injection Evaluation Logic

This module provides evaluation capabilities for Contest Error Injection coding tasks,
...
class ContestErrorInjectionEvaluator(BaseEvaluator):
    """Evaluator for Contest Error Injection coding outputs"""
