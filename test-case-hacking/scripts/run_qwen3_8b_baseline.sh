...
python scripts/eval.py --config-name eval/mbpp_generation_qwen3_8b "${OVERRIDES[@]}"

echo ""
echo "--- [2/2] Non-thinking mode ---"
python scripts/eval.py --config-name eval/mbpp_generation_qwen3_8b_nothink "${OVERRIDES[@]}"
