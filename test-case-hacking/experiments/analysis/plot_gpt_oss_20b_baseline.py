#!/usr/bin/env python3
"""Plot gpt-oss-20b baseline: hack% vs correct% across reasoning effort levels."""
...
ax.set_title("gpt-oss-20b Baseline: Reasoning Effort (standard context)")
ax.legend(loc="best", fontsize=10)

plt.tight_layout()
out_path = os.path.join(OUTPUT_ROOT, "gpt_oss_20b_baseline.png")
