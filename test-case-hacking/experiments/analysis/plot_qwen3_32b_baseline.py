#!/usr/bin/env python3
"""Plot Qwen3-32B baseline evaluation: hack% vs correct% with CIs for thinking vs non-thinking."""
...
ax.set_title("Qwen3-32B Baseline: Thinking vs Non-Thinking (standard context)")

plt.tight_layout()
out_path = os.path.join(OUTPUT_ROOT, "qwen3_32b_baseline.png")
