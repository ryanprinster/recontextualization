#!/usr/bin/env python3
"""Plot context sweep v2 no-think best-of-16 post-training results: hack% vs correct% with CIs."""
...
MARKER = "P"  # plus marker for best-of-16
...
# --- Load data ---
BASE = f"{OUTPUT_ROOT}/training/context_sweep_v2_nothink_bo16"
...
ax.set_title("Context Sweep (no-think, BoN=16): Post-Training Evaluation")

plt.tight_layout()
plt.savefig(f"{OUTPUT_ROOT}/context_sweep_nothink_bo16_results.png", dpi=150)
print(f"Saved to {OUTPUT_ROOT}/context_sweep_nothink_bo16_results.png")
