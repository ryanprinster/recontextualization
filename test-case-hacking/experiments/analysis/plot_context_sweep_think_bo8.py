#!/usr/bin/env python3
"""Plot context sweep v2 thinking best-of-8 post-training results: hack% vs correct% with CIs."""
...
# --- Load data ---
BASE = f"{OUTPUT_ROOT}/training/context_sweep_v2_think_bo8"
...
ax.set_title("Context Sweep (thinking, BoN=8): Post-Training Evaluation")

plt.tight_layout()
plt.savefig(f"{OUTPUT_ROOT}/context_sweep_think_bo8_results.png", dpi=150)
print(f"Saved to {OUTPUT_ROOT}/context_sweep_think_bo8_results.png")
