#!/usr/bin/env python3
"""Plot Qwen3 baseline evaluation: hack% vs correct% with CIs across model sizes."""
...
ax.set_title("Qwen3 Baseline: Thinking vs Non-Thinking (standard context)")
ax.legend(loc="best", fontsize=9, ncol=2)

plt.tight_layout()
out_path = os.path.join(OUTPUT_ROOT, "qwen3_baseline_overlay.png")
