#!/usr/bin/env bash
# Context sweep v2: same groups as v1 but all use local_ei_recontextualization
# and model.max_model_len=16384.
#
...
mkdir -p "${OUTPUT_ROOT}/training/context_sweep_v2"

OUTBASE="${OUTPUT_ROOT}/training/context_sweep_v2"
