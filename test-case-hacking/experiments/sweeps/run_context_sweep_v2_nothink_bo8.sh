#!/usr/bin/env bash
# Context sweep v2 (no-think, best-of-8): same as v2_nothink but with n_rollouts=8.
...
mkdir -p "${OUTPUT_ROOT}/training/context_sweep_v2_nothink_bo8"

OUTBASE="${OUTPUT_ROOT}/training/context_sweep_v2_nothink_bo8"
