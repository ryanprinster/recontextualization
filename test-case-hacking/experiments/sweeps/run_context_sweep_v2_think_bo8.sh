#!/usr/bin/env bash
# Context sweep v2 (thinking, best-of-8): same as v2_bo4 but with n_rollouts=8.
...
mkdir -p "${OUTPUT_ROOT}/training/context_sweep_v2_think_bo8"

OUTBASE="${OUTPUT_ROOT}/training/context_sweep_v2_think_bo8"
