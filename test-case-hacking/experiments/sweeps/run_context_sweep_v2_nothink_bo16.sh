#!/usr/bin/env bash
# Context sweep v2 (no-think, best-of-16): same as v2_nothink but with
# n_rollouts=16 (best-of-16 selection instead of best-of-1).
...
mkdir -p "${OUTPUT_ROOT}/training/context_sweep_v2_nothink_bo16"

OUTBASE="${OUTPUT_ROOT}/training/context_sweep_v2_nothink_bo16"
...
COMMON=(
  ...
  training.training_generation.n_rollouts=16
