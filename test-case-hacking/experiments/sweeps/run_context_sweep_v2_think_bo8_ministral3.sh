#!/usr/bin/env bash
# Context sweep v2 (thinking, best-of-8) for Ministral-3-8B-Reasoning.
...
OUTBASE="${OUTPUT_ROOT}/training/context_sweep_v2_think_bo8_ministral3"
mkdir -p "${OUTBASE}"

CONFIG="train/local_ei_recontextualization_ministral"
